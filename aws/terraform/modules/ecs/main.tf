    ...
    secrets = [
      {
        ...
        valueFrom = "arn:aws:ssm:${var.region}:${data.aws_caller_identity.current.account_id}:parameter/${var.name_prefix}/jwt-access-secret"
      },
      {
        name      = "JWT_REFRESH_SECRET"
        valueFrom = "arn:aws:ssm:${var.region}:${data.aws_caller_identity.current.account_id}:parameter/${var.name_prefix}/jwt-refresh-secret"
      }
    ]
